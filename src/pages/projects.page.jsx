        ...
        <div className={styles.innerContainer}>
          {projects.map((project, index) => (
            <Link aria-label={`Go ${project.title}`} id={project.id} key={project.id} scroll={false} href={project.link} className={clsx(styles.card)}>
              ...
              >
                <div className={clsx(styles.container, 'layout-grid-inner')}>
                  ...
                  <div className={styles.imageContainer}>
                    <Image priority sizes="100%" src={project.overlayImg || project.img} fill alt={project.title} />
                  </div>
                </div>
              </div>
              <div
              ...
              >
                <Image priority sizes="100%" className={index === 0 ? styles.firstCard : index === projects.length - 1 ? styles.lastCard : undefined} src={project.img} fill alt={project.title} />
              </div>
            </Link>
          ))}
        </div>
