  ...
  return (
    <section ref={rootRef} className={clsx(styles.root, 'layout-block-inner')}>
      <header className={styles.titleContainer}>
        <h2 className={clsx(styles.title, 'h2')}>Bots, servers, 3D sites, optimization, and scripts — built with precision.</h2>
      </header>
      <div className={styles.wrapper}>
        <div ref={heroImageRef} className={styles.imageContainer}>
          <Image priority quality={100} src="/3d.webp" sizes="100%" fill alt="Team portfolio visual" />
        </div>
      </div>
    </section>
  );
